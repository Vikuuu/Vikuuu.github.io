...
title: "Gobase"
pubDate: 2024-11-02
description: "Gobase: Automatic schema detection that creates the migrations for your code"
author: "Guts Thakur"
tags: ["go", "systems programming", "migrations", "tool"]
---
import { LinkPreview } from 'astro-embed';

<LinkPreview id="https://github.com/Vikuuu/gobase" / >
